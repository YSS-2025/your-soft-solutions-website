...
export async function POST(req: NextRequest) {
    ...
    const confirmationMessage = `
        <div> 
        <p style="text-align: center;"><span style="font-family: georgia, palatino, serif; font-size: 11pt;"><a title="Your Soft Solutions" href="https://www.yoursoftsolutions.com" rel="noopener noreferrer"><img src="blob:https://rmt7nuk8iqe5gdom.public.blob.vercel-storage.com/Logo%20Only%20Small-Zksas6jmh98Oq8ENoIcWuTnfNGDjYv.png" width="150" height="132" /></a></span></p>
